...
const frItems = {
  ...
  75: {
    ...
    season: 0,
    platform: [1],
    text: "Move your starters to the PS team and replace them with PS players",
  ...
  87: {
    ...
    note: "(Leave them in free agency instead of placing them on the PS team)",
  },
  88: {
    stepNum: 22,
    guide: [1],
...
function checkForSavedProgress() {
  ...
  console.log(
    `chosenGuide: ${chosenGuide}, curseason: ${curSeason}, curYear: ${curYear}, progress: ${progress}`
  );
  return true;
}
...
function updateCookies() {
  cookies.setCookie("progress", progress, {
    expires: cookies.setCookieDate(9999),
    samesite: "lax",
  });
  cookies.setCookie("curSeason", curSeason, {
    expires: cookies.setCookieDate(9999),
    samesite: "lax",
  });
  cookies.setCookie("curYear", curYear, {
    expires: cookies.setCookieDate(9999),
    samesite: "lax",
  });
  cookies.setCookie("chosenGuide", chosenGuide, {
    expires: cookies.setCookieDate(9999),
    samesite: "lax",
  });
