...
const drPosImportantAttr = {
  qb: { attr: ["thp", "spd", "tha", "car"] },
  hb: { attr: ["spd", "agi", "btk", "acc", "cth", "car"] },
  fb: { attr: ["spd", "cth", "str", "rbk", "pbk"] },
  wr: { attr: ["spd", "cth", "agi", "acc", "jmp", "car", "btk"] },
  te: { attr: ["spd", "cth", "agi", "acc", "jmp", "str", "rbk", "pbk"] },
  t: { attr: ["str", "agi", "pbk", "rbk", "acc", "spd"] },
  g: { attr: ["str", "agi", "pbk", "rbk", "acc", "spd"] },
  c: { attr: ["str", "agi", "pbk", "rbk", "acc", "spd"] },
  de: { attr: ["str", "acc", "tak", "agi"] },
  dt: { attr: ["str", "acc", "tak", "agi"] },
  olb: { attr: ["spd", "acc", "tak", "str", "agi"] },
  mlb: { attr: ["spd", "acc", "tak", "str", "agi"] },
  cb: { attr: ["spd", "acc", "agi", "cth", "tak"] },
  fs: { attr: ["spd", "acc", "agi", "cth", "tak"] },
  ss: { attr: ["spd", "acc", "agi", "cth", "tak"] },
  k: { attr: ["kpw", "kac"] },
  p: { attr: ["kpw", "kac"] },
};
const drAttributes = {
